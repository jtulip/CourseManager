...
public class EditLecturerPanel extends JPanel {
    /**
     * 
     */
     ...
     * Create the panel.
     */
    public EditLecturerPanel() {
        setBackground(SystemColor.controlHighlight);
        setBorder(new TitledBorder(null, "Edit Lecturer", TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        JButton updateLecturerButton = new JButton("Update");
        updateLecturerButton.setFont(new Font("Tahoma", Font.PLAIN, 14));
        updateLecturerButton.setBounds(148, 228, 126, 33);
        add(updateLecturerButton);
